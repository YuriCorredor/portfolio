...
export default function Projects() {
    ...
    return (
        <section id="projects" className="flex flex-col justify-center items-center w-full mt-16">
            ...
            <footer className="relative w-full mt-16">
                <div className="flex flex-col items-center z-[9999] pb-2 sm:pb-2 p-2 sm:p-8 relative w-full">
                    <p className="p-2 pt-3 text-xs text-bold text-white">© Copyright | Yuri Corredor </p>
                </div>
            </footer>
